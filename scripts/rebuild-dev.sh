...
# rebuild-dev.sh - Script to rebuild Admin Demo Docker image from scratch
#
...
echo "🔨 Rebuilding Admin Demo Docker image (clean build)..."
echo ""

# Remove old images
echo "🧹 Removing old Docker images..."
docker images | grep -E "many_faces_admin|admin-demo" | awk '{print $3}' | xargs docker rmi -f 2>/dev/null || true
