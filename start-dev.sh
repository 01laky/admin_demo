...
# Script to start Admin Demo Frontend in Docker container for development
...
echo ""
echo "🚀 Starting Admin Demo Frontend in Docker container..."
...
docker-compose build admin-demo-dev
...
if curl -s http://localhost:8082 > /dev/null 2>&1; then
    ...
    echo "   - View logs: docker-compose logs -f admin-demo-dev"
    echo "   - Stop: docker-compose down"
    echo "   - Restart: docker-compose restart admin-demo-dev"
else
