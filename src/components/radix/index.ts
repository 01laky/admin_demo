/**
 * Radix UI Components - Re-exports for easy importing
 *
 * All Radix UI components are available and ready to use.
 * They are headless (unstyled) components that provide accessibility
 * and behavior, while you add your own styling.
 */

// Accordion - Collapsible content sections
export * as Accordion from '@radix-ui/react-accordion';

// Alert Dialog - Modal dialogs for alerts
